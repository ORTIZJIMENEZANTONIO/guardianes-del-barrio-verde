...
export const chapter5Dialogues: Record<string, DialoguePool> = {
  ...
  'cinematic-intro': {
    ...
    lines: [
      { id: 'ci-1', speaker: 'nube-gris', emotion: 'mischievous', text: 'Jaja, ¿plantas en un techo? Eso se va a morir solito.' },
      { id: 'ci-2', speaker: 'timo', emotion: 'excited', text: 'Esas azoteas son sartenes gigantes. ¡Pero podemos convertirlas en jardines!' },
    ],
  },
  ...
  'welcome': {
    ...
    lines: [
      { id: 'w-1', speaker: 'xani', emotion: 'excited', text: 'Las azoteas verdes no son ciencia ficción. El CIIEMAD del IPN ya investiga jardines en techos.' },
      {
        id: 'w-2',
        speaker: 'lila',
        emotion: 'excited',
      ...
      { id: 'w-3', speaker: 'xani', emotion: 'neutral', text: 'Una azotea verde reduce hasta 5°C la temperatura interior y captura agua de lluvia.' },
    ],
  },
  ...
  'mission-0-intro': {
    ...
    lines: [
      { id: 'm0i-1', speaker: 'xani', emotion: 'excited', text: 'En el CIIEMAD del IPN estudian techos verdes. Un techo gris llega a 70°C, ¡pero uno verde solo a 35°C!' },
      { id: 'm0i-2', speaker: 'timo', emotion: 'excited', text: 'Un techo verde es como un sándwich de capas. ¡Vamos a armarlo, {nombre}!' },
      { id: 'm0i-3', speaker: 'nube-gris', emotion: 'mischievous', text: '¿Plantas en un techo? Eso no va a funcionar.', optional: true },
    ],
  },
  'mission-0-success': {
    ...
    lines: [
      ...
      { id: 'm0s-2', speaker: 'xani', emotion: 'happy', text: 'Las plantas van a dar sombra, limpiar el aire y darle casa a mariposas y abejas.', optional: true },
    ],
  },
  'mission-0-failure': {
  ...
  'mission-1-intro': {
    ...
    lines: [
      { id: 'm1i-1', speaker: 'timo', emotion: 'excited', text: '{nombre}, antes de plantar hay que asegurarnos de que la azotea aguante.' },
      { id: 'm1i-2', speaker: 'xani', emotion: 'thinking', text: 'Hay 6 puntos para revisar, pero solo 4 necesitan atención. ¡Toca cada uno!' },
      { id: 'm1i-3', speaker: 'nube-gris', emotion: 'mischievous', text: '¡Yo apuesto a que el techo se cae!', optional: true },
    ],
  },
  'mission-1-success': {
    ...
    lines: [
      ...
      { id: 'm1s-2', speaker: 'xani', emotion: 'happy', text: 'Carga, drenaje, sol y agua: todo verificado.', optional: true },
    ],
  },
  'mission-1-failure': {
  ...
  'mission-2-success': {
    ...
    lines: [
      ...
      { id: 'm2s-2', speaker: 'timo', emotion: 'excited', text: 'Huerto, captador de agua, paneles solares… ¡azotea inteligente!', optional: true },
    ],
  },
  'mission-2-failure': {
  ...
  'mission-3-intro': {
    ...
    lines: [
      { id: 'm3i-1', speaker: 'xani', emotion: 'excited', text: '{nombre}, las plantas de azotea deben aguantar sol, viento y poca agua.' },
      { id: 'm3i-2', speaker: 'xani', emotion: 'happy', text: '¡Encuentra las parejas entre cada condición y su planta ideal!' },
      { id: 'm3i-3', speaker: 'timo', emotion: 'neutral', text: 'La planta correcta en el lugar correcto. ¡Como un rompecabezas!', optional: true },
    ],
  },
  'mission-3-success': {
    ...
    lines: [
      { id: 'm3s-1', speaker: 'xani', emotion: 'proud', text: '¡Perfecto, {nombre}! Cada planta en su lugar ideal. ¡La azotea ya se ve verde!' },
      { id: 'm3s-2', speaker: 'bolillo', emotion: 'happy', text: '*olfatea las plantas desde abajo* ¡Huele bonito!', optional: true },
    ],
  },
  'mission-3-failure': {
  ...
  'mission-4-intro': {
    ...
    lines: [
      { id: 'm4i-1', speaker: 'timo', emotion: 'excited', text: '{nombre}, última misión: conectar el captador de lluvia con las jardineras.' },
      { id: 'm4i-2', speaker: 'timo', emotion: 'happy', text: '¡Arrastra cada pieza al lugar correcto! Pero cuidado, hay piezas que no sirven.' },
      { id: 'm4i-3', speaker: 'nube-gris', emotion: 'mischievous', text: '¡Ojalá les quede chueco!', optional: true },
    ],
  },
  'mission-4-success': {
    ...
    lines: [
      ...
      { id: 'm4s-2', speaker: 'xani', emotion: 'excited', text: 'Un captador puede recolectar cientos de litros al año. ¡Riego ecológico y gratuito!', optional: true },
    ],
  },
  'mission-4-failure': {
  ...
  'chapter-5-ending': {
    ...
    lines: [
      { id: 'e-1', speaker: 'lila', emotion: 'proud', text: '¡Lo logramos, {nombre}! Donde antes había concreto gris, ahora hay vida.' },
      { id: 'e-2', speaker: 'xani', emotion: 'proud', text: 'Si cada edificio tuviera una azotea verde, la temperatura bajaría varios grados.' },
      { id: 'e-3', speaker: 'lila', emotion: 'excited', text: 'El barrio sigue cambiando, {nombre}. ¡Y todavía falta lo mejor!' },
    ],
  },
