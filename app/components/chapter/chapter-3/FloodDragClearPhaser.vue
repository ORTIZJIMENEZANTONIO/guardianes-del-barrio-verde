<template>
  <MinigameShell
    ...
    description="Arrastra los obstáculos a la zona segura."
    :completed="completed"
    :total="5"
  ...
  >
    <div class="flooddragclear-game">
      ...
      <PhaserCanvas
        v-if="gameStarted"
        ref="phaserRef"
        :scene-class="FloodDragClearScene"
        :bridge="bridge"
      />
      ...
      <!-- Progress bar -->
      <div class="flooddragclear-progress">
        <span class="flooddragclear-progress__text">
          Obstáculos retirados: {{ completed }}/5
        </span>
      </div>
    </div>
  </MinigameShell>
