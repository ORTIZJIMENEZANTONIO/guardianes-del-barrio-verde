<template>
  <MinigameShell
    ...
    description="Encuentra las parejas para aprender sobre el humedal."
    :completed="completed"
    :total="4"
  ...
  >
    <div class="wetlandmemory-game">
      ...
      <PhaserCanvas
        v-if="gameStarted"
        ref="phaserRef"
        :scene-class="WetlandMemoryScene"
        :bridge="bridge"
      />
      ...
      <!-- Progress bar -->
      <div class="wetlandmemory-progress">
        <span class="wetlandmemory-progress__text">
          Parejas encontradas: {{ completed }}/4
        </span>
      </div>
    </div>
  </MinigameShell>
...
import { WetlandMemoryScene } from '~/phaser/scenes/chapter-3/WetlandMemoryScene'
