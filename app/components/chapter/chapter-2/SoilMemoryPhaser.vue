<template>
  ...
  >
    <div class="soilmemory-game">
      ...
      <!-- Progress bar -->
      <div class="soilmemory-progress">
        <span class="soilmemory-progress__text">
