<template>
  <MinigameShell
    ...
    description="Arrastra cada elemento al lugar correcto."
    :completed="completed"
    :total="5"
    ...
    @retry="resetGame"
  >
    <div class="parkdragrestore-game">
      ...
      <PhaserCanvas
        v-if="gameStarted"
        ref="phaserRef"
        :scene-class="ParkDragRestoreScene"
        :bridge="bridge"
      />
      ...
      <Transition name="fade">
        <div
          v-if="feedback"
          class="parkdragrestore-feedback"
      ...
      <!-- Progress bar -->
      <div class="parkdragrestore-progress">
        <span class="parkdragrestore-progress__text">
          Elementos restaurados: {{ completed }}/5
        </span>
      </div>
    </div>
  </MinigameShell>
...
import { ParkDragRestoreScene } from '~/phaser/scenes/chapter-2/ParkDragRestoreScene'
...
.parkdragrestore-progress__text {
  font-size: 13px;
  font-weight: 800;
