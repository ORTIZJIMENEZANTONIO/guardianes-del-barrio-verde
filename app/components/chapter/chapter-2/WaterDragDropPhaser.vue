<template>
  <MinigameShell
    ...
    description="Arrastra las gotas a las plantas que las necesitan."
    :completed="completed"
    :total="4"
  ...
  >
    <div class="waterdragdrop-game">
      ...
      <PhaserCanvas
        v-if="gameStarted"
        ref="phaserRef"
        :scene-class="WaterDragDropScene"
        :bridge="bridge"
      />
      ...
      <!-- Progress bar -->
      <div class="waterdragdrop-progress">
        <span class="waterdragdrop-progress__text">
          Plantas regadas: {{ completed }}/4
        </span>
      </div>
    </div>
  </MinigameShell>
