<template>
  <MinigameShell
    ...
    description="Encuentra las parejas: cada animal necesita algo para volver."
    :completed="completed"
    :total="4"
  ...
  >
    <div class="wildlifememory-game">
      ...
      <PhaserCanvas
        v-if="gameStarted"
        ref="phaserRef"
        :scene-class="WildlifeMemoryScene"
        :bridge="bridge"
      />
      ...
      <!-- Progress bar -->
      <div class="wildlifememory-progress">
        <span class="wildlifememory-progress__text">
