<template>
  ...
  >
    <SwipeClassifier
      ...
      left-color="#ef4444"
      right-color="#22c55e"
      error-message="Observa bien: ¿esta amenaza la causan las personas o sucede sola en la naturaleza?"
...
const items: SwipeItem[] = [
  ...
  { id: 't3', emoji: '🏭', label: 'Contaminación industrial', category: 'left', fact: 'Las fábricas vierten químicos en ríos y lagos, afectando a los animales acuáticos.' },
  ...
  { id: 't8', emoji: '🛍️', label: 'Tráfico de especies', category: 'left', fact: 'Vender animales exóticos como mascotas es ilegal y pone en riesgo a miles de guacamayas y loros cada año.' },
]
