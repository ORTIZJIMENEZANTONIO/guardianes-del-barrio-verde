<template>
  <MinigameShell
    ...
    description="Toca las superficies. Encuentra los 3 puntos más calientes."
    :completed="completed"
    :total="3"
  ...
  >
    <div class="heatdetector-game">
      ...
      <!-- Progress bar -->
      <div class="heatdetector-progress">
        <span class="heatdetector-progress__text">
          Puntos calientes: {{ completed }}/3
        </span>
      </div>
    </div>
  </MinigameShell>
...
import { HeatDetectorScene } from '~/phaser/scenes/chapter-1/HeatDetectorScene'
import type { MinigameBridge } from '~/phaser/types'

defineEmits<{ complete: [] }>()

const completed = ref(0)
const isComplete = computed(() => completed.value >= 3)
