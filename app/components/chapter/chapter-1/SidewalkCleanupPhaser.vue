<template>
  <MinigameShell
    ...
    @timeout="onTimeout"
  >
    <div class="sidewalkcleanup-game">
      ...
      <PhaserCanvas
        v-if="gameStarted"
        ref="phaserRef"
        :scene-class="SidewalkCleanupScene"
        :bridge="bridge"
      />
      ...
      <Transition name="fade">
        <div
          v-if="feedback"
          class="sidewalkcleanup-feedback"
      ...
      <!-- Progress bar -->
      <div class="sidewalkcleanup-progress">
        <span class="sidewalkcleanup-progress__text">
          Residuos clasificados: {{ completed }}/10
        </span>
      </div>
    </div>
  </MinigameShell>
...
import { SidewalkCleanupScene } from '~/phaser/scenes/chapter-1/SidewalkCleanupScene'
import type { MinigameBridge } from '~/phaser/types'

defineEmits<{ complete: [] }>()

const completed = ref(0)
const isComplete = computed(() => completed.value >= 10)
...
.sidewalkcleanup-progress__text {
  font-size: 13px;
  font-weight: 800;
