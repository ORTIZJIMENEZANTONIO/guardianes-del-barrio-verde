<template>
  <MinigameShell
    ...
    description="Selecciona elementos y colócalos para transformar la calle."
    :completed="completed"
    :total="5"
  ...
  >
    <div class="spacerestorer-game">
      ...
      <PhaserCanvas
        v-if="gameStarted"
        ref="phaserRef"
        :scene-class="SpaceRestorerScene"
        :bridge="bridge"
      />
      ...
      <!-- Progress bar -->
      <div class="spacerestorer-progress">
        <span class="spacerestorer-progress__text">
          Elementos colocados: {{ completed }}/5
        </span>
      </div>
    </div>
  </MinigameShell>
...
import { SpaceRestorerScene } from '~/phaser/scenes/chapter-1/SpaceRestorerScene'
